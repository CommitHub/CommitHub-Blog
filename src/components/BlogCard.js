...
class BlogCard extends Component {
  ...
  render() {
    return (
      <section className="blog-card-container" onClick={this.redirect}>
        <section
          ...
          <section>
            ...
            <section className="author-container">
              <div
                ...
                style={{
                  backgroundImage: `url(${this.props.blog.authorImage})`,
                }}
              >
                <span className="sr-only">
                  Image of {this.props.blog.author}
                </span>
              </div>
              <section className="author-info">
                ...
                <span>
                  {moment(this.props.blog.date).format('MMM Do YYYY')}
                </span>
              </section>
            </section>
          </section>
